...
const tidyUpData = (data, result) => {
  ...
  // }
  // coding here ...
  data.map(({station_id,station_name,station_type,station_order,address,service_counter,enable_bicycle,distance_to_next})=>{
    if(result[station_type] == undefined){
      result[station_type] = []
    }
    result[station_type].push({
