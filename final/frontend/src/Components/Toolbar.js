...
const Toolbar = ({contextRef, canvasRef, handleChange, setMode, mode})=>{
    ...
    <img src={broom} className="icon" width="30" height="30" onClick={()=>{contextRef.current.clearRect(0, 0, canvasRef.current.width, canvasRef.current.height)}} />
    </div>)
}
